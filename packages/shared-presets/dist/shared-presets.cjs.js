...
var Table = styled__default['default'].table(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\twidth: 100%;\n\tmargin: 0;\n\tborder-spacing: 0;\n\tborder-collapse: collapse;\n\n\ttbody {\n\n\t\ttr {\n\n\t\t\t&:nth-child(2n+2) {\n\t\t\t\tbackground-color: #f8f8f8;\n\t\t\t}\n\t\t}\n\n\t\ttd {\n\t\t\tpadding: 9px;\n\t\t\tvertical-align: center;\n\t\t\tcolor: #888;\n\t\t\tfont: 500 13px/22px \"Roboto\", sans-serif;\n\t\t\tletter-spacing: -0.25px;\n\n\t\t\t&:first-child {\n\t\t\t\tpadding-left: 20px;\n\t\t\t\tcolor: #333;\n\t\t\t}\n\n\t\t\t&:last-child {\n\t\t\t\tpadding-right: 20px;\n\t\t\t}\n\t\t}\n\t}\n"])));
    ...
    value: function render() {
      var rows = React.Children.map(this.props.children, function (row) {
        return /*#__PURE__*/React__default['default'].createElement("tr", null, /*#__PURE__*/React__default['default'].createElement("td", {
          colSpan: "2"
        }, row.props.name), /*#__PURE__*/React__default['default'].createElement("td", {
          colSpan: "1"
        }, row.props.status));
      });
    ...
    value: function render() {
      ...
      var options = React.Children.map(this.props.children, function (option) {
        ...
        if (option.props.href) {
          return /*#__PURE__*/React__default['default'].createElement("li", null, /*#__PURE__*/React__default['default'].createElement("a", _extends$4({
...
var Header$1 = styled__default['default'].div(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n\tmargin: 0 0 20px;\n\n\t> div {\n\n\t\t@media ", " {\n\t\t\tmin-width: 1px;\n\t\t\tflex: 1;\n\t\t}\n\t}\n\n\t> button {\n\t\tmargin: 10px 0 0 !important;\n\n\t\t@media ", " {\n\t\t\tflex: 0 0 auto;\n\t\t\tmargin-top: 0 !important;\n\t\t\tmargin-left: 10px !important;\n\t\t}\n\t}\n\n\t@media ", " {\n\t\tdisplay: flex;\n\t\talign-items: center;\n\t}\n"])), device.tablet, device.tablet, device.tablet);
var Label = styled__default['default'].p(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n\tmargin: 0 !important;\n\tcolor: #333 !important;\n"])));
...
var PresetsAccordionItem = /*#__PURE__*/function (_Component) {
  ...
  _createClass(PresetsAccordionItem, [{
    ...
    value: function render() {
      ...
      var title = this.props["default"] ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, this.props.title, icon) : this.props.title;
      return /*#__PURE__*/React__default['default'].createElement("div", {
        className: clazz
      }, /*#__PURE__*/React__default['default'].createElement(AccordionItemHeader, {
        ...
        className: "sui-label"
      }, this.props.title), /*#__PURE__*/React__default['default'].createElement(Description, {
        className: "sui-description"
      }, this.props.description)), /*#__PURE__*/React__default['default'].createElement(ButtonIcon$1, {
        icon: "pencil",
...
var ButtonIcon$3 = /*#__PURE__*/React__default['default'].forwardRef(function (_ref, ref) {
  ...
  if (props.href) {
    return /*#__PURE__*/React__default['default'].createElement("a", _extends$5({
      ref: ref,
      className: className,
      disabled: props.disabled || props.loading
    }, props), props.loading ? loader : content);
  ...
  return /*#__PURE__*/React__default['default'].createElement("button", _extends$5({
    ref: ref,
    className: className,
    disabled: props.disabled || props.loading
  }, props), props.loading ? loader : content);
...
var NoticeBlue = styled__default['default'].div(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n.sui-wrap && {\n    display: flex;\n    flex-flow: row wrap;\n\n    > img {\n        max-width: 100px;\n        display: none;\n        align-self: flex-end;\n        flex: 0 0 auto;\n        margin-right: 30px;\n    }\n\n    > div.sui-notice {\n        min-width: 1px;\n        flex: 1;\n        padding-bottom: ", ";\n    }\n\n    @media ", " {\n\n        > img {\n            display: block;\n        }\n\n        > div.sui-notice {\n            padding-bottom: ", ";\n        }\n    }\n}\n"])), utils$1.gutter_md, device$2.tablet, utils$1.gutter);
  ...
  _createClass(PresetsPage, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(Box, null, /*#__PURE__*/React__default['default'].createElement(BoxHeader, {
        ...
        color: "blue"
      }))), /*#__PURE__*/React__default['default'].createElement(BoxBody, {
        paddingBottom: welcome.message ? 0 : 30
      }, this.props.description && /*#__PURE__*/React__default['default'].createElement("p", null, this.props.description), welcome.message && /*#__PURE__*/React__default['default'].createElement(NoticeBlue, null, /*#__PURE__*/React__default['default'].createElement("img", {
        src: welcome.image,
        ...
        type: "info",
        dismiss: true
      }, /*#__PURE__*/React__default['default'].createElement("p", null, welcome.message)))), !empty && /*#__PURE__*/React__default['default'].createElement("div", {
        className: "sui-accordion sui-accordion-flushed",
        style: {
          borderBottomWidth: 0
        }
        ...
        type: "upsell"
      }, /*#__PURE__*/React__default['default'].createElement("p", null, freez.message), freez.button && '' !== freez.message && /*#__PURE__*/React__default['default'].createElement("p", null, /*#__PURE__*/React__default['default'].createElement(Button, {
        label: freez.button,
        color: "purple",
        href: "https://wpmudev.com/",
        target: "_blank"
      })))), !free && /*#__PURE__*/React__default['default'].createElement(BoxFooter, {
        display: "block",
        alignment: "center"
