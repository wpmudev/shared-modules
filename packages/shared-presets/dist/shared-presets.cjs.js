...
var Notifications = /*#__PURE__*/function (_Component) {
  ...
  function Notifications(props) {
    ...
    _defineProperty$5(_assertThisInitialized$2(_this), "close", function () {
      _this.setState({
        hide: true
      });
    });
...
var _excluded$3 = ["type", "label", "labelId", "id", "name", "image", "defaultChecked", "disabled"];
...
var RadioCheckboxInput$1 = function RadioCheckboxInput(_ref) {
  var type = _ref.type,
      ...
      props = _objectWithoutProperties$7(_ref, _excluded$3);
...
var Modal$1 = /*#__PURE__*/function (_React$Component) {
  ...
  function Modal(props) {
    ...
    _defineProperty$3(_assertThisInitialized$1(_this), "clearTimer", function () {
      var _this$timeout;
  ...
  _createClass$1(Modal, [{
    ...
    value: function render() {
      ...
      var childrenArray = [/*#__PURE__*/React__default["default"].createElement('div', _objectSpread2$3({}, dialogProps), props.children)];
      ...
      }, /*#__PURE__*/React__default["default"].createElement('div', _objectSpread2$3({}, underlayProps), childrenArray));
    }
  }]);
...
var Input = function Input(_ref) {
  var id = _ref.id,
      ...
      props = _objectWithoutProperties$4(_ref, ["id", "size", "label", "description", "type"]);
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    htmlFor: uniqueId,
    className: "sui-label"
  }, label), /*#__PURE__*/React__default["default"].createElement("input", _extends$3({
    id: uniqueId,
    type: type,
    className: clazz
  ...
  _createClass$3(PresetsTable, [{
    ...
    value: function render() {
      var rows = React.Children.map(this.props.children, function (row) {
        ...
        return /*#__PURE__*/React__default["default"].createElement("tr", null, /*#__PURE__*/React__default["default"].createElement("td", null, rowName), /*#__PURE__*/React__default["default"].createElement("td", null, rowContent.map(function (item) {
          if (item.includes('Inactive')) {
            return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, item, rowTag, '\n');
          }
...
var PresetsAccordionItem = /*#__PURE__*/function (_Component) {
  ...
  function PresetsAccordionItem(props) {
    ...
    _defineProperty$6(_assertThisInitialized$3(_this), "toggle", function (e) {
    ...
    _defineProperty$6(_assertThisInitialized$3(_this), "accordionHeadApplyClicked", function (e) {
      e.stopPropagation();
  ...
  _createClass$3(PresetsAccordionItem, [{
    ...
    value: function render() {
      ...
      }), /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, !isWidget && /*#__PURE__*/React__default["default"].createElement("div", {
        size: null !== date && '' !== date ? '3' : '5'
      }, /*#__PURE__*/React__default["default"].createElement("div", {
        style: descstyles
      }, description))), /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, null !== date && '' !== date && !isWidget && /*#__PURE__*/React__default["default"].createElement("div", {
        size: "2"
      }, /*#__PURE__*/React__default["default"].createElement("div", {
        style: descstyles
...
var Presets = function Presets(_ref) {
  ...
  }), /*#__PURE__*/React__default["default"].createElement("span", null, "Config Name")), /*#__PURE__*/React__default["default"].createElement("div", {
