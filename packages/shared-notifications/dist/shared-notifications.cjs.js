...
var NoticeDiscount = function NoticeDiscount(_ref) {
  ...
  return !isClose && /*#__PURE__*/React__default['default'].createElement(Wrapper, _extends({
    className: "sui-notice-offer"
  }, props), /*#__PURE__*/React__default['default'].createElement(Header, null, hasDiscount && /*#__PURE__*/React__default['default'].createElement(Ribbon, null, discount, "% Off"), null !== title && '' !== title && /*#__PURE__*/React__default['default'].createElement(Title, null, title), /*#__PURE__*/React__default['default'].createElement("button", {
  ...
  }, closeLabel || 'Close this offer'))), /*#__PURE__*/React__default['default'].createElement(Body, null, hasImage1x && !hasImage2x && /*#__PURE__*/React__default['default'].createElement(Image, {
    src: image,
    ...
    alt: imageAlt || 'Plugin image',
    "aria-hidden": "true"
  }), /*#__PURE__*/React__default['default'].createElement(Content, null, children, hasDisclaimer && /*#__PURE__*/React__default['default'].createElement("p", {
    className: "sui-disclaimer"
  }, "* ", disclaimer)), /*#__PURE__*/React__default['default'].createElement(Border, null, /*#__PURE__*/React__default['default'].createElement("span", null)), /*#__PURE__*/React__default['default'].createElement(PriceWrapper, null, /*#__PURE__*/React__default['default'].createElement(PriceLabel, null, priceLabel || 'Pay Only'), hasDiscount ? /*#__PURE__*/React__default['default'].createElement(Price, null, /*#__PURE__*/React__default['default'].createElement("span", null, "$", price), /*#__PURE__*/React__default['default'].createElement("strong", null, "$", newPrice), "/", priceTime || 'month') : /*#__PURE__*/React__default['default'].createElement(Price, null, /*#__PURE__*/React__default['default'].createElement("strong", null, "$", price), "/", priceTime || 'month'), hasButton && /*#__PURE__*/React__default['default'].createElement(Button, {
    label: buttonLabel,
    color: "purple",
    href: buttonLink,
    target: "_blank"
