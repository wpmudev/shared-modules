...
var _templateObject$8, _templateObject2$6, _templateObject3$5, _templateObject4$5, _templateObject5$5, _templateObject6$4;
...
BlackFriday.Container = styled__default["default"].div(_templateObject2$6 || (_templateObject2$6 = _taggedTemplateLiteral$6(["\n[class*=\"sui-2-\"] .sui-wrap & {\n\toverflow: hidden;\n\tposition: relative;\n\tmargin: 0 0 20px;\n\tpadding: 30px 40px;\n\tborder-radius: 4px;\n\tbackground-color: #07212C;\n\tbackground-image: image-set(\n\t\turl(", ") 1x,\n\t\turl(", ") 2x\n\t);\n\tbackground-image:\n\t\timage-set(\n\t\t\turl(", ") 1x,\n\t\t\turl(", ") 2x\n\t\t),\n\t\tlinear-gradient(270deg, #222222 0.67%, #07212C 100%);\n\n\t@media ", " {\n\t\ttext-align: center;\n\t}\n\n\t@media ", " {\n\t\tdisplay: flex;\n\t\tmargin: 0 0 30px;\n\t\tflex-flow: row nowrap;\n\t\talign-items: flex-start;\n\t\tpadding-left: 0;\n\t}\n\n\t@media ", " {\n\t\talign-items: center;\n\t}\n\n\t.sui-button-icon {\n\t\tposition: absolute;\n\t\ttop: 10px;\n\t\tright: 10px;\n\t\tmargin-right: 0 !important;\n\t}\n}\n"])), img$1, img, img$1, img, maxDevice.tablet, minDevice.tablet, minDevice.laptop);
BlackFriday.Ribbon = styled__default["default"].div(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral$6(["\n[class*=\"sui-2-\"] .sui-wrap & {\n\tdisplay: inline-block;\n\tpadding: 10px 20px 11px;\n\tbackground-color: #6D53AB;\n\tcolor: #4DFD89;\n\tfont-size: 22px;\n\tline-height: 29px;\n\tfont-weight: bold;\n\tletter-spacing: normal;\n\n\t@media ", " {\n\t\tflex: 0 0 auto;\n\t\tpadding: 15px 20px 16px;\n\t}\n}\n"])), minDevice.tablet);
BlackFriday.Body = styled__default["default"].div(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral$6(["\n[class*=\"sui-2-\"] .sui-wrap & {\n\tmargin: 0 0 30px;\n\n\t@media ", " {\n\t\tmin-width: 1px;\n\t\tflex: 1;\n\t\tmargin: 0 15px;\n\t\tpadding-right: 65px;\n\t}\n\n\t@media ", " {\n\t\tdisplay: flex;\n\t\tflex-flow: row nowrap;\n\t\talign-items: center;\n\t\tpadding-right: 0;\n\t}\n}\n"])), minDevice.tablet, minDevice.laptop);
BlackFriday.Content = styled__default["default"].div(_templateObject5$5 || (_templateObject5$5 = _taggedTemplateLiteral$6(["\n[class*=\"sui-2-\"] .sui-wrap & {\n\tmargin: 30px 0;\n\n\t@media ", " {\n\t\tmargin-top: 0;\n\t}\n\n\t@media ", " {\n\t\tmin-width: 1px;\n\t\tflex: 1;\n\t\tmargin-bottom: 0;\n\t}\n\n\th1, h2, h3, h4, h5, h6, p, small {\n\t\tcolor: #fff;\n\t}\n\n\tp {\n\t\tmargin: 0 0 15px;\n\t\tfont-size: 18px;\n\t\tline-height: 25px;\n\n\t\t@media ", " {\n\t\t\tmargin: 0 0 5px;\n\t\t}\n\n\t\t&:last-child {\n\t\t\tmargin: 0;\n\t\t}\n\n\t\tstrong {\n\t\t\tfont-weight: 700;\n\n\t\t\t@media ", " {\n\t\t\t\tdisplay: block;\n\t\t\t\tmargin-bottom: 20px;\n\t\t\t\tfont-size: 28px;\n\t\t\t\tline-height: 29px;\n\t\t\t}\n\t\t}\n\n\t\tsmall {\n\t\t\tmargin: 0;\n\t\t\tdisplay: initial;\n\t\t\tfont-size: 13px;\n\t\t\tline-height: 22px;\n\t\t\tfont-weight: 300;\n\t\t}\n\t}\n}\n"])), minDevice.tablet, minDevice.laptop, minDevice.tablet, maxDevice.tablet);
...
})(_templateObject6$4 || (_templateObject6$4 = _taggedTemplateLiteral$6(["\n[class*=\"sui-2-\"] .sui-wrap & {\n\tcursor: pointer;\n\tdisplay: inline-block;\n\tmargin: 0;\n\tpadding: 5px 30px;\n\tborder: 0;\n\tborder-radius: 30px;\n\tbackground: #4DFD89;\n\tbox-shadow: none;\n\tcolor: #222;\n\tfont-size: 13px;\n\tline-height: 30px;\n\tfont-weight: bold;\n\ttext-decoration: none;\n\ttransition: 0.2s ease;\n\n\t&:hover,\n\t&:focus {\n\t\tbackground: #fff;\n\t\tcolor: #222222 !important;\n\t}\n\n\t&:focus {\n\t\tbox-shadow: 0 0 10px 0 rgba(255,255,255,0.3);\n\t}\n\n\t@media ", " {\n\t\tdisplay: block;\n\t\tflex: 0 0 auto;\n\t}\n}\n"])), minDevice.laptop);
...
var _templateObject$7, _templateObject2$5, _templateObject3$4, _templateObject4$4, _templateObject5$4, _templateObject6$3, _templateObject7$2, _templateObject8$2, _templateObject9, _templateObject10, _templateObject11, _templateObject12;
...
Discount.Wrapper = styled__default["default"].div(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral$5(["\n\toverflow: hidden;\n\tdisplay: block;\n\tborder-radius: 4px;\n\tbackground-color: #fff;\n"])));
Discount.Header = styled__default["default"].div(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral$5(["\n\tdisplay: flex;\n\tflex-flow: row wrap;\n\talign-items: center;\n\tjustify-content: space-between;\n\tbackground-color: #8D00B1;\n\n\t.sui-button-icon {\n\t\tflex: 0 0 auto;\n\t\tmargin: 16px 20px !important;\n\n\t\t&:only-child {\n\t\t\tmargin-left: auto !important;\n\t\t}\n\t}\n"])));
Discount.Ribbon = styled__default["default"].div(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral$5(["\n\tflex: 0 0 auto;\n\tposition: relative;\n\tmargin: 12px 0;\n\tpadding: 10px 23px 10px 15px;\n\tbackground-color: #FECF2F;\n\tcolor: #000;\n\tfont-size: 13px;\n\tline-height: 18px;\n\tfont-weight: bold;\n\tletter-spacing: normal;\n\n\t&:after {\n\t\tcontent: \" \";\n\t\tdisplay: block;\n\t\tposition: absolute;\n\t\ttop: 0;\n\t\tright: 0;\n\t\tborder-width: 19px 12px;\n\t\tborder-style: solid;\n\t\tborder-color: #FECF2F;\n\t\tborder-right-color: #8D00B1;\n\t\tborder-left-width: 0;\n\t}\n\n\t@media ", " {\n\t\tpadding-right: 25px;\n\t\tfont-size: 14px;\n\t}\n"])), device$4.tablet);
Discount.Title = styled__default["default"].h2(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral$5(["\n\tmin-width: 1px;\n\tflex: 1;\n\tmargin: 0 20px !important;\n\tpadding: 11px 0 !important;\n\tborder: 0 !important;\n\tcolor: #fff !important;\n\tfont-size: 13px !important;\n\tline-height: 21px !important;\n\tfont-weight: bold !important;\n\tletter-spacing: normal !important;\n\n\t& + & .sui-button-icon {\n\t\tmargin-left: 0 !important;\n\t}\n\n\t@media ", " {\n\t\tpadding: 20px 0 21px !important;\n\t\tfont-size: 16px !important;\n\t}\n"])), device$4.tablet);
Discount.Body = styled__default["default"].div(_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral$5(["\n\ttext-align: center;\n\n\t@media ", " {\n\t\tdisplay: flex;\n\t\tflex-flow: row wrap;\n\t\talign-items: center;\n\t}\n"])), device$4.tablet);
Discount.Image = styled__default["default"].img(_templateObject7$2 || (_templateObject7$2 = _taggedTemplateLiteral$5(["\n\tdisplay: none;\n\tflex: 0 0 auto;\n\talign-self: flex-end;\n\tmargin: 0 10px;\n\tpadding: 0 30px;\n\n\t+ div {\n\n\t\t@media ", " {\n\t\t\tpadding-left: 0 !important;\n\t\t}\n\t}\n\n\t@media ", " {\n\t\tdisplay: block;\n\t}\n"])), device$4.tablet, device$4.tablet);
...
var NoticeDiscount = function NoticeDiscount(_ref) {
  ...
  return !isClose && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(Discount.Global, null), /*#__PURE__*/React__default["default"].createElement("div", _extends$7({
...
var Link$2 = styled__default["default"].a(_templateObject$3(), function (props) {
    ...
    value: function render() {
      ...
      var options = React.Children.map(this.props.children, function (option) {
        ...
        if (option.props.href) {
          return /*#__PURE__*/React__default["default"].createElement("li", null, /*#__PURE__*/React__default["default"].createElement(Link$2, _extends$6({
...
var Table = styled__default["default"].table(_templateObject$2$1 || (_templateObject$2$1 = _taggedTemplateLiteral$3(["\n[class*=\"sui-2-\"] .sui-wrap && {\n\twidth: 100%;\n\tmargin: 0;\n\tborder-spacing: 0;\n\tborder-collapse: collapse;\n\ttable-layout: fixed;\n\n\ttbody {\n\n\t\ttr {\n\n\t\t\t&:nth-child(2n+2) {\n\t\t\t\tbackground-color: #f8f8f8;\n\t\t\t}\n\t\t}\n\n\t\ttd {\n\t\t\tpadding: 9px;\n\t\t\tvertical-align: center;\n\t\t\tcolor: #888;\n\t\t\tfont: 500 13px/22px \"Roboto\", sans-serif;\n\t\t\tletter-spacing: -0.25px;\n\n\t\t\tdiv {\n\t\t\t\toverflow: hidden;\n\t\t\t\tdisplay: -webkit-box;\n\t\t\t\ttext-overflow: ellipsis;\n\t\t\t\t-webkit-line-clamp: 2;\n\t\t\t\t-webkit-box-orient: vertical\n\t\t\t}\n\n\t\t\t&:first-child {\n\t\t\t\twidth: 45%;\n\t\t\t\tpadding-left: 20px;\n\t\t\t\tcolor: #333;\n\t\t\t}\n\n\t\t\t&:last-child {\n\t\t\t\twidth: 55%;\n\t\t\t\tpadding-right: 20px;\n\t\t\t\twhite-space: pre-wrap;\n\t\t\t}\n\t\t}\n\t}\n}\n"])));
...
var Header = styled__default["default"].div(_templateObject$1$2 || (_templateObject$1$2 = _taggedTemplateLiteral$3(["\n\tmargin: 0 0 20px;\n\n\t> div:not(.sui-tooltip) {\n\n\t\t@media ", " {\n\t\t\tmin-width: 1px;\n\t\t\tflex: 1;\n\t\t}\n\t}\n\n\t> div.sui-tooltip {\n\t\tmargin: 10px 0 0 !important;\n\n\t\t@media ", " {\n\t\t\tflex: 0 0 auto;\n\t\t\tmargin-top: 0 !important;\n\t\t\tmargin-left: 10px !important;\n\t\t}\n\t}\n\n\t@media ", " {\n\t\tdisplay: flex;\n\t\talign-items: center;\n\t}\n"])), device$1$2.tablet, device$1$2.tablet, device$1$2.tablet);
var Label = styled__default["default"].p(_templateObject2$1$2 || (_templateObject2$1$2 = _taggedTemplateLiteral$3(["\n\tmargin: 0 !important;\n\tcolor: #333 !important;\n"])));
var Description = styled__default["default"].p(_templateObject3$1$2 || (_templateObject3$1$2 = _taggedTemplateLiteral$3(["\n\tmargin: 3px 0 0 !important;\n"])));
var Authentic = styled__default["default"].svg(_templateObject4$1$1 || (_templateObject4$1$1 = _taggedTemplateLiteral$3(["\n    margin-left: 10px;\n"])));
var AccordionItemHeaderAlt = styled__default["default"](AccordionItemHeader)(_templateObject5$1$1 || (_templateObject5$1$1 = _taggedTemplateLiteral$3(["\n[class*=\"sui-2-\"] .sui-wrap && {\n\n\t> .sui-accordion-col-5 {\n\n\t\t@media ", " {\n\t\t\tdisplay: none !important;\n\t\t}\n\t}\n\n    > .sui-accordion-col-auto {\n\n\t\t.sui-presets-item__apply {\n\n\t\t\t@media ", " {\n\t\t\t\tdisplay: none;\n\t\t\t}\n\t\t}\n\n\t\t> .sui-dropdown {\n\n            [class*=sui-icon-] {\n                margin-right: 0 !important;\n            }\n\n            ul {\n                min-width: 192px;\n            }\n        }\n    }\n\n\t&:not(:hover):not(:focus) {\n\n\t\t> .sui-accordion-col-auto {\n\n\t\t\t.sui-presets-item__apply {\n\t\t\t\topacity: 0;\n\t\t\t}\n\t\t}\n\t}\n}\n"])), deviceMax.tablet, deviceMax.tablet);
...
var PresetsAccordionItem = /*#__PURE__*/function (_Component) {
  ...
  _createClass$2$2(PresetsAccordionItem, [{
    ...
    value: function render() {
      ...
      })))), /*#__PURE__*/React__default["default"].createElement(AccordionItemBody, null, /*#__PURE__*/React__default["default"].createElement(Box$1, null, /*#__PURE__*/React__default["default"].createElement(BoxBody, null, /*#__PURE__*/React__default["default"].createElement(Header, null, /*#__PURE__*/React__default["default"].createElement("div", null, /*#__PURE__*/React__default["default"].createElement(Label, {
        className: "sui-label"
...
var LoadingContent = styled__default["default"].div(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral$3(["\n.sui-wrap && {\n    position: relative;\n    z-index: 2;\n}\n"])));
var LoadingWrap = styled__default["default"].div(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral$3(["\n.sui-wrap && {\n    pointer-events: none;\n}"])));
var LoadingMask = styled__default["default"].div(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral$3(["\n.sui-wrap && {\n    width: 100%;\n    height: 100%;\n    display: flex;\n    flex-flow: row wrap;\n    align-items: center;\n    justify-content: center;\n    position: absolute;\n    top: 0;\n    left: 0;\n    background-color: rgba(255,255,255,0.95);\n    border-radius: 0 0 4px 4px;\n\n    > p {\n\n    }\n}\n"])));
var StyledSyncButton = styled__default["default"].button(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral$3(["\n.sui-wrap && {\n\tcolor: #17A8E3;\n\tfont-weight: 600;\n\tbackground-color: transparent;\n\tborder: none;\n\tcursor: pointer;\n\ttext-decoration: none;\n\tdisplay: inline;\n\tmargin: 0;\n\tpadding: 0;\n}\n"])));
var StyledBoxHeader = styled__default["default"].div(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral$3(["\n[class*=\"sui-2-\"] .sui-wrap && {\n\n\t.sui-actions-right {\n\n\t\t@media ", " {\n\t\t\tjustify-content: space-between;\n\t\t\tmargin-top: 9px;\n\t\t}\n\t}\n\n\t@media ", " {\n\t\tdisplay: block;\n\t}\n}\n"])), deviceMax.tablet, deviceMax.tablet);
var RequestsHandler;
...
var Presets = function Presets(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    "aria-live": "assertive"
  })), /*#__PURE__*/React__default["default"].createElement(Box$1, null, PresetsHeader, /*#__PURE__*/React__default["default"].createElement(BoxBody, null, getDescription(), !isLoading && isEmpty && /*#__PURE__*/React__default["default"].createElement(Notifications$2, {
    type: "info"
