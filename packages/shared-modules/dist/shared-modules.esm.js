...
var NoticeDiscount = function NoticeDiscount(_ref) {
  ...
  return !isClose && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Discount.Global, null), /*#__PURE__*/React.createElement("div", _extends$9({
    ...
    className: "sui-module-notice-discount__price"
  }, /*#__PURE__*/React.createElement("strong", null, "$", price), "/", priceTime || 'month'), hasButton && /*#__PURE__*/React.createElement(Button$3, {
    label: buttonLabel,
    color: "purple",
    href: buttonLink,
    target: "_blank"
...
var Button$1$1 = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement(htmlTag, _objectSpread2$4$1({
    className: className,
    disabled: props.disabled || loading
  }, props), loading ? loader : content);
};
...
var Modal$2 = function Modal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(AltModal, _extends$4$1({
...
var ItemImage = styled.span(_templateObject$4$1 || (_templateObject$4$1 = _taggedTemplateLiteral$1$3(["\n\twidth: 30px;\n\theight: 30px;\n\tmargin-right: 10px;\n\tborder-radius: 10px;\n\tbackground-repeat: no-repeat;\n\tbackground-size: cover;\n\tbackground-position: center;\n"])));
...
var Button$2 = styled.button(_templateObject2$2$1(), function (props) {
  return 'blue' === props.color ? 'color: #17A8E3 !important;' : '';
}, function (props) {
  return 'green' === props.color ? 'color: #1ABC9C !important;' : '';
}, function (props) {
  ...
  _createClass$5(Dropdown, [{
    ...
    value: function render() {
      ...
      var options = Children.map(this.props.children, function (option) {
        ...
        return /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(Button$2, option.props, label));
      });
...
var Post$1 = /*#__PURE__*/function (_Component) {
  ...
  _createClass$4(Post, [{
    ...
    value: function render() {
      ...
      if (this.props.image) {
        PostImage = /*#__PURE__*/React.createElement(FeaturedImage$1, _extends$4({
...
var ListWrapper$1 = styled.ul(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral$1$2(["\n\tdisplay: block;\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\n\t@media ", " {\n\t\tdisplay: flex;\n\t\tflex-flow: row wrap;\n\t\tmargin: -15px;\n\t}\n"])), device$3.tablet);
var ListItem$1 = styled.li(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral$1$2(["\n\tdisplay: block;\n\tmargin: 0 0 20px;\n\n\t&:last-child {\n\t\tmargin-bottom: 0;\n\t}\n\n\t@media ", " {\n\t\twidth: 50%;\n\t\tmargin: 0;\n\t\tflex: 0 0 auto;\n\t\tpadding: 15px;\n\t}\n\n\t@media ", " {\n\t\twidth: 33.33%;\n\t}\n\n\t@media ", " {\n\t\twidth: 25%;\n\t}\n\n\t@media (min-width: 1800px) {\n\t\t.sui-tutorials--page li {\n\t\t\twidth: 20%;\n\t\t}\n\t}\n"])), device$3.tablet, device$3.laptop, device$3.desktop);
...
var Box = styled.div(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral$1$1(["\n\tposition: relative;\n\tpadding: 10px;\n\n\t@media ", " {\n\t\tpadding: 15px 25px;\n\t}\n"])), device$2.tablet);
...
var ListWrapper = styled.ul(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral$1$1(["\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\n\t@media ", " {\n\t\toverflow: hidden;\n\t\tdisplay: flex;\n\t\tflex-flow: row nowrap;\n\t}\n"])), device$2.tablet);
var ListItem = styled.li(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral$1$1(["\n\tdisplay: block;\n\tmargin: 0 0 20px;\n\tpadding: 0;\n\tborder: 0;\n\tlist-style: none;\n\n\t&:last-child {\n\t\tmargin-bottom: 0;\n\t}\n\n\t@media ", " {\n\t\twidth: 33.33%;\n\t\tflex: 0 0 auto;\n\t\tmargin: 0 1px 0 0;\n\t}\n\n\t@media ", " {\n\t\twidth: 25%;\n\t}\n"])), device$2.tablet, device$2.desktop);
var Navigation = styled.div(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral$1$1(["\n\tdisplay: block;\n\n\tbutton[class*=\"sui-button-\"] {\n\t\tdisplay: none !important;\n\n\t\t@media ", " {\n\t\t\tdisplay: block !important;\n\t\t\tpointer-events: initial;\n\t\t}\n\t}\n\n\tbutton:not([class*=\"sui-button-\"]) {\n\t\twidth: 100%;\n\t\tcursor: pointer;\n\t\tdisplay: flex;\n\t\tflex-flow: row wrap;\n\t\talign-items: center;\n\t\tjustify-content: center;\n\t\tmargin: 20px 0 10px !important;\n\t\tpadding: 10px !important;\n\t\tborder: 0;\n\t\tborder-radius: 4px;\n\t\tbackground-color: #fff;\n\t\tcolor: #17a8e3 !important;\n\t\ttransition: 0.2s ease all;\n\n\t\t* {\n\t\t\tpointer-events: none;\n\t\t}\n\n\t\tstrong {\n\t\t\tmin-width: 1px;\n\t\t\tflex: 0 1 auto;\n\t\t\tcolor: inherit;\n\t\t\tfont-size: 13px;\n\t\t\tline-height: 22px;\n\t\t\tfont-weight: 500;\n\t\t}\n\n\t\t[class*=\"sui-icon-\"] {\n\t\t\tflex: 0 0 auto;\n\t\t\tmargin-left: 5px;\n\t\t\ttransition: 0.2s ease all;\n\n\t\t\t&:before {\n\t\t\t\tcolor: inherit;\n\t\t\t}\n\t\t}\n\n\t\t&:hover,\n\t\t&:focus {\n\t\t\toutline: none;\n\t\t\tbox-shadow: none;\n\t\t}\n\n\t\t&:hover {\n\t\t\tbackground-color: #fafafa;\n\t\t}\n\n\t\t&:focus {\n\t\t\tbackground-color: #e1f6ff;\n\t\t}\n\n\t\t@media ", " {\n\t\t\tdisplay: none !important;\n\t\t}\n\t}\n\n\t.open & {\n\t\tbutton:not([class*=\"sui-button-\"]) {\n\t\t\t[class*=\"sui-icon-\"] {\n\t\t\t\ttransform: rotate(180deg);\n\t\t\t}\n\t\t}\n\t}\n\n\t@media ", " {\n\t\tpointer-events: none;\n\t\tdisplay: flex;\n\t\tflex-flow: row wrap;\n\t\talign-items: center;\n\t\tjustify-content: space-between;\n\t\tposition: absolute;\n\t\ttop: 50%;\n\t\tright: 6px;\n\t\tleft: 6px;\n\t\ttransform: translateY(-50%);\n\t}\n"])), device$2.tablet, device$2.tablet, device$2.tablet);
var SkipArticles = styled.a(_templateObject6$2 || (_templateObject6$2 = _taggedTemplateLiteral$1$1(["\n\tposition: absolute;\n\ttop: -1000em;\n\tz-index: 1;\n\t&:focus {\n\t\tleft: 0;\n\t\ttop: 0;\n\t\tline-height: normal;\n\t\tfont-size: 13px;\n\t\tfont-weight: 500;\n\t\tpadding: 15px 23px 14px;\n\t\tbackground: #fff;\n\t\tcolor: #1286b5;\n\t\toutline: none;\n\t\tborder-radius: 3px;\n\t\tbox-shadow: 0 2px 7px 0 rgb(0 0 0 / 5%), 0 0 2px 0 #17a8e3 !important;\n\t}\n"])));
...
var Wrapper = styled.div(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-session__wrapper {\n\tposition: relative;\n}\n"])));
var Button$1 = styled.button(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-session__button {\n\tmargin: 0 !important;\n\t", "\n\tborder-radius: 50%;\n\tbackground: #E6E6E6;\n\n\t&:hover,\n\t&:focus {\n\t\tbackground: #E6E6E6;\n\t}\n\n\t.suicons {\n\t\tfont-size: 16px;\n\t}\n}\n"])), function (props) {
  return props.hasAvatar ? 'padding: 0 !important;' : '';
});
var Image = styled.span(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-session__avatar {\n\twidth: 26px;\n\theight: 26px;\n\tdisplay: block;\n\tborder-radius: 50%;\n\tbackground-repeat: no-repeat;\n\tbackground-size: cover;\n}\n"])));
var Flag = styled.span(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-session__flag {\n\tpointer-events: none;\n\twidth: 12px;\n\theight: 12px;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\tposition: absolute;\n\tright: 1px;\n\tbottom: -4px;\n\tborder: 1px solid #FFF;\n\tborder-radius: 50%;\n\tbackground: ", ";\n\ttext-align: center;\n\n\t[class*=\"sui-icon-\"] {\n\t\tmargin-top: 1px;\n\t\tfont-size: 6px;\n\n\t\t&:before {\n\t\t\tcolor: #FFF;\n\t\t}\n\t}\n}\n"])), function (props) {
...
var StyledIcon$1 = styled.span(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-session__ddmenu-icon.suicons {\n\twidth: 24px;\n\tposition: relative;\n\ttop: 2px;\n\tdisplay: inline-block;\n\tmargin-right: 10px;\n\tfont-size: 16px;\n\ttext-align: center;\n\n\t&:before {\n\t\tdisplay: block;\n\t}\n}\n"])));
var StyledButton = styled.button(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-session--purple {\n\n\t&,\n\t&:hover,\n\t&:focus {\n\t\tcolor: #8D00B1;\n\t}\n\n\t&:hover,\n\t&:focus {\n\t\tbackground-color: #F9E1FF;\n\t}\n}\n"])));
var StyledLink = styled.a(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-session--purple {\n\n\t&,\n\t&:hover,\n\t&:focus,\n\t&:visited {\n\t\tcolor: #8D00B1;\n\t}\n\n\t&:hover,\n\t&:focus {\n\t\tbackground-color: #F9E1FF;\n\t}\n}\n"])));
var StyledInfo = styled.li(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral$1(["\n.sui-wrap && {\n\tpadding: 0 15px 10px;\n\tfont-size: 13px;\n\tfont-weight: 500;\n\tline-height: 20px;\n\tletter-spacing: -0.25px;\n}\n"]))); // Build "Session Menu" component.
...
var StyledTitle = styled.p(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-perks__title {\n\tcolor: #333;\n\tfont-size: 13px;\n\tfont-weight: 500;\n\tline-height: 12px;\n\tletter-spacing: -0.25px;\n}\n"])));
var StyledList = styled.ul(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-perks {\n\tdisplay: flex;\n\tflex-flow: row wrap;\n\tmargin: 0 0 20px;\n\tpadding: 0;\n\tborder: 0;\n\tlist-style: none;\n\n\t&:last-child {\n\t\tmargin-bottom: 0;\n\t}\n\n\t@media ", " {\n\t\tdisplay: flex;\n\t\tflex-flow: row wrap;\n\t\tmargin-left: -7px;\n\t\tmargin-right: -7px;\n\n\t\t&:last-child {\n\t\t\tmargin-bottom: -10px;\n\t\t}\n\n\t\t.ssm-perk {\n\t\t\twidth: 50%;\n\t\t\tflex: 0 0 auto;\n\t\t\tpadding: 0 7px;\n\t\t}\n\t}\n}\n"])), minDevice.tablet);
var StyledIcon = styled.span(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-perk__icon {\n\twidth: 22px;\n\theight: 22px;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\tborder: 1px solid #DDD;\n\tborder-radius: 6px;\n\ttext-align: center;\n\n\t.suicons {\n\t\tdisplay: block;\n\t\tcolor: #1A1A1A;\n\t\tfont-size: 12px;\n\n\t\t&:before {\n\t\t\tdisplay: block;\n\t\t}\n\t}\n}\n"])));
var StyledItem = styled.li(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-perk {\n\tcolor: #666;\n\tfont-size: 12px;\n\tline-height: 20px;\n\n\t.ssm-perk__icon {\n\t\tposition: absolute;\n\t\ttop: 0;\n\t\tleft: 0;\n\t}\n}\n"])));
var StyledItemWrapper = styled.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-perk__wrapper {\n\tposition: relative;\n\tmargin-bottom: 10px;\n\tpadding-left: 35px;\n}\n"])));
var StyledItemTitle = styled.span(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral$1(["\n.sui-wrap &&.ssm-perk__title {\n\tdisplay: block;\n\tcolor: #333;\n\tfont-size: 12px;\n\tfont-weight: 600;\n\tline-height: 16px;\n}\n"]))); // Build "Session List" component.
...
export { Header, NoticeBanner, NoticeBlack, NoticeDiscount, SessionList as Perks, Presets, TutorialsList, TutorialsSlider };
